...
<?php if ( !(simple_writer_get_option('hide_tags_title')) ) { ?>
<div class="simple-writer-page-header-outside">
<header class="simple-writer-page-header">
<div class="simple-writer-page-header-inside">
<?php the_archive_title( '<h1 class="page-title">', '</h1>' ); ?>
<?php if ( !(simple_writer_get_option('hide_tags_description')) ) { ?><?php the_archive_description( '<div class="taxonomy-description">', '</div>' ); ?><?php } ?>
</div>
</header>
</div>
<?php } ?>
